"""HuggingFace inference wrapper for MOSS-Music."""
...
def read_env_model_id() -> str:
    return os.environ.get("MOSS_MUSIC_MODEL_ID", DEFAULT_MODEL_ID)
...
class MossMusicHFInference:
    ...
    def __init__(
        ...
        self.device = device
        self.model = MossMusicModel.from_pretrained(
            model_name_or_path,
        ...
        self.model.eval()
        self.processor = MossMusicProcessor.from_pretrained(
            model_name_or_path,
            trust_remote_code=True,
...
__all__ = ["MossMusicHFInference", "read_env_model_id", "resolve_device"]
